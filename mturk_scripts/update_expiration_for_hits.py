...
def main(args):
    ...
    for hit_id in wanted_hit_ids:
        mturk.update_expiration_for_hit(HITId=hit_id, ExpireAt=datetime(*args.expire_at))
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--expire-at', dest='expire_at', type=int, nargs='+', help="Datetime to expire at", required=True)
